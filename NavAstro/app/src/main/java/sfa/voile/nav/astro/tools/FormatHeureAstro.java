 ...
 * @author pierr
 */
public class FormatHeureAstro {
    private static Logger _logger = LoggerFactory.getLogger(FormatHeureAstro.class);
    ...
    final public static FormatHeureAstro[] _allRegex = {
        // Pb de l'encodage Windows du signe degre ....
        new FormatHeureAstro("([+-]?)(\\d+)[,\\.](\\d+)'", "-25.89 [en decimal]", 3, false, true),
    ...
    FormatHeureAstro(String s, String e, int i) {
        _regExp = s;
        _exemple = e;
        _nbGroup = i;
    }
