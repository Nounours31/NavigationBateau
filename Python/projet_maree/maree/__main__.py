...
from maree import MareeScrapperFactory, MareeScrapper
...
if __name__ == '__main__':
    ...
    allOrigines : dict = MareeScrapperFactory.MareeScrapperFactory.getOrigines()
    ...
    source : MareeScrapper = MareeScrapperFactory.MareeScrapperFactory.getScrapper(iOrigine)
