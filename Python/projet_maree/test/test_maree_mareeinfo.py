...
import platform
import pytz
from maree import MareeScrapperMareeInfo
import datetime
import os
import tempfile
...
class test_maree_mareeinfo(unittest.TestCase):
    ...
    def test_getListPort (self) -> None :
        xx : MareeScrapperMareeInfo.MareeScrapperMareeInfo = MareeScrapperMareeInfo.MareeScrapperMareeInfo()
    ...
    def test_privateConvertionTextVersValeurMaree (self) -> None : 
        xx : MareeScrapperMareeInfo.MareeScrapperMareeInfo = MareeScrapperMareeInfo.MareeScrapperMareeInfo()
        self.assertEqual(xx._MareeScrapperMareeInfo__convertionTextVersValeurMaree(["2,23m"], datetime.datetime(2015, 3, 4, 0, 0, tzinfo=pytz.utc),0), [2.23])
        self.assertEqual(xx._MareeScrapperMareeInfo__convertionTextVersValeurMaree(["2.23m"], datetime.datetime(2015, 3, 4, 0, 0, tzinfo=pytz.utc),0), [2.23])
        self.assertEqual(xx._MareeScrapperMareeInfo__convertionTextVersValeurMaree(["2h23"], datetime.datetime(2015, 3, 4, 0, 0, tzinfo=pytz.utc),0), 
                         [datetime.datetime(2015, 3, 4, 2, 23, tzinfo=pytz.utc)])
        self.assertEqual(xx._MareeScrapperMareeInfo__convertionTextVersValeurMaree(["2h23"], datetime.datetime(2015, 3, 4, 0, 0, tzinfo=pytz.utc),2), 
                         [datetime.datetime(2015, 3, 4, 0, 23, tzinfo=pytz.utc)])
        self.assertEqual(xx._MareeScrapperMareeInfo__convertionTextVersValeurMaree(["23"], datetime.datetime(2015, 3, 4, 0, 0, tzinfo=pytz.utc),0), [23])
        self.assertEqual(xx._MareeScrapperMareeInfo__convertionTextVersValeurMaree(["2,23m","2h23", "23"], datetime.datetime(2015, 3, 4, 0, 0, tzinfo=pytz.utc),0), 
                         [2.23, datetime.datetime(2015, 3, 4, 2, 23, tzinfo=pytz.utc), 23])
        self.assertEqual(xx._MareeScrapperMareeInfo__convertionTextVersValeurMaree(["2m","2h", "ddd"], datetime.datetime(2015, 3, 4, 0, 0, tzinfo=pytz.utc),0), 
