...
public class CoursDeNavigation_DocAncien_page4_loxodromie300Milles {
	private static final Logger logger = LoggerFactory
			.getLogger(CoursDeNavigation_DocAncien_page4_loxodromie300Milles.class);
	...
	public void test001_page4_Cas1_Loxodromie_Distanceinferieur300milles() throws NavException {
		PointGeographique pgDepart = PointGeographiqueFactory.fromLatLong(LatitudeFactory.fromString("35°54.2 N"),
				LongitudeFactory.fromString("14°30.5 E"));

		PointGeographique pgArrivee = PointGeographiqueFactory.fromLatLong(LatitudeFactory.fromString("38°11.3 N"),
				LongitudeFactory.fromString("15°34.7 E"));

		Distance distanceOrtho = DistanceFactory.fromMn(146.4);
	...
	public void test002_page4_Cas2_Loxodromie_Distanceinferieur300milles() throws NavException {
		PointGeographique pgDepart = PointGeographiqueFactory.fromLatLong(LatitudeFactory.fromString("50°53.7 N"),
				LongitudeFactory.fromString("1°23.5 W"));

		PointGeographique pgArrivee = PointGeographiqueFactory.fromLatLong(LatitudeFactory.fromString("51°03.8 N"),
				LongitudeFactory.fromString("2°22.7 E"));

		Distance distanceOrtho = DistanceFactory.fromMn(142.8);
	...
	public void test003_page4_Cas3_Loxodromie_Distanceinferieur300milles() throws NavException {
		PointGeographique pgDepart = PointGeographiqueFactory.fromLatLong(LatitudeFactory.fromString("27°50.0 S"),
				LongitudeFactory.fromString("178°30 E"));

		PointGeographique pgArrivee = PointGeographiqueFactory.fromLatLong(LatitudeFactory.fromString("29°17 S"),
				LongitudeFactory.fromString("179°05.7 W"));

		Distance distanceOrtho = DistanceFactory.fromMn(153.8);
	...
	public void test004_page4_Cas4_Loxodromie_Distanceinferieur300milles() throws NavException {
		PointGeographique pgDepart = PointGeographiqueFactory.fromLatLong(LatitudeFactory.fromString("37°29.8 S"),
				LongitudeFactory.fromString("9°12 E"));

		PointGeographique pgArrivee = PointGeographiqueFactory.fromLatLong(LatitudeFactory.fromString("37°29.1 S"),
	...
	public void test005_page4_Cas5_Loxodromie_Distanceinferieur300milles() throws NavException {
		PointGeographique pgDepart = PointGeographiqueFactory.fromLatLong(LatitudeFactory.fromString("1°06.7 N"),
				LongitudeFactory.fromString("15°36 W"));

		PointGeographique pgArrivee = PointGeographiqueFactory.fromLatLong(LatitudeFactory.fromString("0°30 S"),
				LongitudeFactory.fromString("13°20 W"));

		Distance distanceOrtho = DistanceFactory.fromMn(166.9);
