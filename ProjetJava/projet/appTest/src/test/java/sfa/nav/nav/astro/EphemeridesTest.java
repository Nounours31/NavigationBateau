...
public class EphemeridesTest {
	...
	public void test001() throws NavException {
		...
		assertEquals (e.toString(), "Ephemerides [ephe1=Ephemerides [GHA=000.000°[00°00'00.00\"][0.00 Rad], declinaison=lat:000.000°[00°00'00.00\"][0.00 Rad] N, heureEnSeconde=2023/01/01 02:00:00 CET [2023/01/01 01:00:00 UTC], varHA=VitesseAngulaire [vitesseInDegreParSeconde=2.777777777777778E-5], varDecli=VitesseAngulaire [vitesseInDegreParSeconde=2.777777777777778E-5], type=ParGradiant], ephe2=null, type=ParGradiant]");
		
		Angle a = e.AngleHoraireLocal_AHL_LHA(hRef.plusHeureDecimale(1.0));
	...
	public void test002() throws NavException {
		...
		assertEquals (e.toString(), "Ephemerides [ephe1=Ephemerides [GHA=000.000°[00°00'00.00\"][0.00 Rad], declinaison=lat:000.000°[00°00'00.00\"][0.00 Rad] N, heureEnSeconde=2023/01/01 02:00:00 CET [2023/01/01 01:00:00 UTC], varHA=null, varDecli=null, type=parInterval], ephe2=Ephemerides [GHA=010.000°[10°00'00.00\"][0.17 Rad], declinaison=lat:010.000°[10°00'00.00\"][0.17 Rad] N, heureEnSeconde=2023/01/01 12:00:00 CET [2023/01/01 11:00:00 UTC], varHA=null, varDecli=null, type=parInterval], type=parInterval]");

		Angle a = e.AngleHoraireLocal_AHL_LHA(NavDateHeure.moyenne(hRef, hRef2));
	...
	public void test003_auxfrontieres() throws NavException {
		...
		Angle a = e.AngleHoraireLocal_AHL_LHA(hRef.plusHeureDecimale(0.001));
		...
		a = e.AngleHoraireLocal_AHL_LHA(hRef2.moinsHeureDecimale(0.001));
		...
		a = e.AngleHoraireLocal_AHL_LHA(hRef.plusHeureDecimale(0.001));
	...
	public void test001_out() throws NavException {
		...
		Angle a = e.AngleHoraireLocal_AHL_LHA(hRef.moinsHeureDecimale(0.001));
	}
	...
	public void test002_out() throws NavException {
		...
		Angle a = e.AngleHoraireLocal_AHL_LHA(hRef2.plusHeureDecimale(0.001));
	}
