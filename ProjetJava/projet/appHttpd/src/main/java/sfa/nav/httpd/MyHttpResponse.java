...
public class MyHttpResponse {
	...
	public enum eMimeTypes {
	                ...
	                libraryms ("application/windows-library+xml"),
	                ...
	                mpv2 ("video/mpeg"),
	                mqv ("video/quicktime"),
	                mstroff ("application/x-troff-ms"),
	                ...
	                searchConnector ("application/windows-search-connector+xml"),
	                ...
	                sln ("text/plain"),
	                slupkg ("application/x-ms-license"),
	                smd ("audio/x-smd"),
				...
				public static eMimeTypes getTypeFromFile(File f) {
					String s = f.getAbsolutePath();
					if (!s.contains("."))
						return eMimeTypes.txt;
					int i = s.lastIndexOf(".");
					String extens = s.substring(i+1);
					for (eMimeTypes x : eMimeTypes.values()) {
