@echo OFF
call e:\users\paps\profile\profile.bat
...
if "%COMPUTERNAME%" == "DESKTOP-15AHP26" (
	set SERVER=PORTABLE_LILI
)
...
if "%SERVER%" == "PORTABLE_LILI" (
	echo "====> PC portable Lili"
	set JAVA_HOME=E:\bin\java\jdk-17.0.10+7
	set GRADLE_HOME=E:\bin\gradle\gradle-8.10
	set CATALINA_HOME=
)
